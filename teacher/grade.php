...
<html>
  ...
  <body class="sidebar-mini fixed">
      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="grade.php"><i class="fa fa-check-square-o"></i><span>Виставити оцінку</span></a></li>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form class="form-horizontal" action="" method="post" id="">
                  ...
                  <div class="form-group">
                     <label class="control-label col-md-3" for="date">Дата</label>
                     <div class="col-md-8">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <input class="form-control" type="tel" inputmode="numeric" name="grade" maxlength="3" placeholder="Enter grade" >
                    </div>
                  </div>
    ...
    <script type="text/javascript">
      ...
      // Get Date of Lesson
      $('#group, #subject').on('change', function(){
      	id_subject = $('#subject').val();
        get_date_of_lesson(id_subject);
      });

      function get_date_of_lesson(id_subject){
      	$('#date').find('option').remove();
        $.ajax({
            url: '../handler.php',
            type: "POST",
            data: ({
                action: 'get_date_of_lesson',
                id_teacher: '<?=$id_teacher?>',
                id_group: $('#group').val(),
            ...
            success: function(data){
                ...
                console.log(data)
                $.each(data['result'], function(index, value){
                  $('#date').append('<option value="'+value['timestamp']+'">'+value['date']+'</option>');
                });
            }
        });
      }
